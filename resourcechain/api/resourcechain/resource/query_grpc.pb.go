...
const (
	Query_Params_FullMethodName      = "/resourcechain.resource.Query/Params"
	Query_Resource_FullMethodName    = "/resourcechain.resource.Query/Resource"
	Query_ResourceAll_FullMethodName = "/resourcechain.resource.Query/ResourceAll"
)
